...
<head>
      ...
      <script type="text/javascript" src="logica-1-l-alura.js"></script>
      <title>Document</title>
</head>
      <style>
            .background{
                  background-color: #9fe4be!important;
                  display: flex;
            ...
            .btn{
                  background-color: #e43ac8!important;
                  display: block;
                  color: #fff;
                  line-height: 40px;
                  height: 40px;
...
<body>
      <div class="background">
            <a class="btn" id="myBtn" href="#">Teste</a>
      </div>      
</body>
<script>
